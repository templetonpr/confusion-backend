...
router.route('/')
  ...
  .post((req, res, next) => { // add a new promotion (admin)
  ...
  .delete((req, res, next) => { // delete all promotions (admin)
...
router.route('/:promo')
  ...
  .put((req, res, next) => { // update a promotion (admin)
    let promotion = req.params.promo;
  ...
  .delete((req, res, next) => { // delete a promotion (admin)
    let promotion = req.params.promo;
